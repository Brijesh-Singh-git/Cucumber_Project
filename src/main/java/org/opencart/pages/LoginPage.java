...
public class LoginPage {
    ...
    private By editAccountLinkLocator = By.linkText("My Account");
    ...
    public boolean checkeditAccountLink() throws InterruptedException {
        Thread.sleep(3000);
        return driver.findElement(editAccountLinkLocator).isDisplayed();
    }
